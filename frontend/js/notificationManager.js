...
class NotificationManager {
    ...
    getNotificationIcon(type) {
        const icons = {
            ...
            auth: 'fa-user-shield',
            permission: 'fa-lock',
            loading: 'fa-hourglass-half fa-pulse',
            saving: 'fa-save fa-pulse',
            uploading: 'fa-cloud-upload-alt fa-pulse',
            downloading: 'fa-cloud-download-alt fa-pulse',
            searching: 'fa-search fa-pulse',
            processing: 'fa-cog fa-pulse',
            complete: 'fa-check-double',
            failed: 'fa-times-circle',
            pending: 'fa-clock fa-pulse',
